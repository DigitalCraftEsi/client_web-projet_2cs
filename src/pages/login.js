...
export function Login() {
  ...
  return (<div className="w-full h-screen bg-green-800 flex justify-center items-center">
    <form className="bg-white w-[400px]  rounded-lg p-8 flex flex-col gap-4">
      ...
      <input ref={emailRef} type="email" id="email" name="email" placeholder="email" className="p-2 rounded-lg outline-none border-2 border-black" required />

      <label htmlFor="password">Password</label>
      <input ref={passwordRef} type="password" id="password" email="password" placeholder="password" className="p-2 rounded-lg outline-none border-2 border-black" required />

      <button onClick={handleLogin} className="rounded-lg bg-green-800 p-2 text-white">Login</button>
